...
<p><strong>Level codes.</strong> Every world card prints a four-letter code.
   <em>Level Code</em> on the title screen takes it back, so a dead battery
   costs you nothing. World 1-1 is <kbd>FJTK</kbd>.</p>
